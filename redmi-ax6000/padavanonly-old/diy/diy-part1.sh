...
git clone https://github.com/rootphantomer/luci-app-adguardhome.git package/luci-app-adguardhome/luci-app-adguardhome
git clone https://github.com/sirpdboy/luci-app-ddns-go.git package/ddns-go
git clone https://github.com/animegasan/luci-app-wolplus.git package/luci-app-wolplus/luci-app-wolplus